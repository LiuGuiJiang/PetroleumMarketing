...
export default {
    data () {
        return {
            ...
            aSingleData:null, //选中单行数据
            checkedData: null, //保存选中行,数据id
            head: '',//表头
            fileName: '报表', //文件名
    ...
    methods: {
        ...
        editMessage () {
            ...
            if(this.aSingleData){
                this.dialogScreenVisible1 = true;
                for(var key in this.messageData){
                    this.messageData[key] = this.aSingleData[key]
                }
            }else {
                this.$message.error('请选中单行！')
            }
        },
        //4.0 新增/编辑确认
        ...
        //2.0选中单行，用于编辑信息
        selectTheSingle (val) {
            this.aSingleData = val
            //console.log(this.aSingleData)
        },
        // 2.1选中复选框
